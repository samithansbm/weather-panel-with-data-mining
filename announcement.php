...
<head>
  ...
  <title>Announcements |  WeatherALPHA</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3" id="admin_announce">
          <div class="card-header">
            <i class="fas fa-chart-area"></i>
            Issue Announcements</div>
            ...
            <div class="card-body">
              <form>
                <div class="form-group">
                  ...
                  <span></span>
                  <small class="text-danger" > Entering a title is necessary</small>
                </div>

                <div class="form-group">
                  <label>Valid for</label>
                  <select id="inputTarget" class="form-control">
                    <option value="A day">24 hours</option>
                    <option value="A week">1 week</option>
                    <option value="A month">1 month</option>
                  </select>
                  <span></span>
                </div>

                <div class="form-group">
                  <label>Target Crowd</label>
                  <select id="inputCrowd" class="form-control">
                ...
                <input  type="hidden" value="" id="inputUsername">
                ...
                <a class="btn btn-primary btn-block" onclick="issueAnnounce(user, out.innerHTML)">Issue</a>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-chart-area"></i>
            Issued Announcements</div>
          <div class="card-body flex-panel">
            
            <div class="content-list">
              <ul id = "issue">
                <li>
                  <span class="list-num">Order</span>
                  <span class="list-name">Sender</span>
                  <span class="list-date">Topic</span>
        ...
        <script src="js/plugins/editor.js"></script>

        <script>
          var user = "<?php if(isset($_SESSION['Username'])) { echo $_SESSION['Username'];} else echo 'NO USER'?>";
          var role = "<?php echo $_SESSION['Role']; ?>";

          var announce = document.getElementById('admin_announce');
          announce.style.display = "none";

          var roles = []
          if(role == "Admin"){
            role = ["All", "Staff", "Member"];
          ...
          getAnnouncements("target", role, "issue");
          //Input Field Values
