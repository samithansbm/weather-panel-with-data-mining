...
<head>
  ...
  <title>Dashboard | WeatherALPHA</title>
...
<body id="page-top" onload="getLocationGraph(6.5854, 79.9607)">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="weather_gen.php">
        <i class="fas fa-umbrella"></i>
          <span>Weather Reporting</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="mails.php">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5"> New Announcements!</div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="announcement.php">
                <span class="float-left">View Details</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body flex-panel">
            ...
            <a href="weather_report.php">
              <div class="panel-item">
                <div class="item-title">Weather Forcast</div>
                <p>To get forcasted information on weather condition</p>
              </div>
            </a>
            <a href="weather_gen.php">
              <div class="panel-item" >
                <div class="item-title">Weather Reporting</div>
                <p>To support researchers and independent Disaster Management Systems</p>
              </div>
            </a>
