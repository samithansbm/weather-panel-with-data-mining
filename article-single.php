    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Single Article</li>
        </ol>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body flex-panel">
            ...
            <div class="container-article">
              <div class="img-head" style="background-image: url('./images/wallpaper/wall (1).jpg')">
                <h1 id="topic">TOPIC</h1>

              </div>
              <div class="article-content" id="contain-text">
                <p>
                  The global economy is on the brink of collapse. Unemployment tops 24%. 
                  Gas is $42 per gallon. Railroads are the main transportation. Brilliant 
                  creators, from artists to industrialists, are mysteriously disappearing. 
                  Dagny Taggart, COO of Taggart Transcontinental, has discovered an answer 
                  to the mounting energy crisis - a prototype of a motor that draws energy 
                  from static electricity. But, until she finds its creator, it's useless. 
                  It's a race against time. And someone is watching.
                </p>
              </div>
              <h6 id="author">No - Author</h6>
              <small id="d-ate">No - Date</small>
            </div>
            

          </div>
          <a href="" class="btn btn-danger" id="btn-auth" onclick="deleteArticle(getUrlVars()['id'])" >Delete</a>
        ...
        <script>
          ...
          var delete_article = document.getElementById('btn-auth');
          delete_article.style.display = "none";
          if(role == "Admin"){
            delete_article.style.display = "block";
          }
          function getUrlVars() {
              var vars = {};
          ...
          // Firebase Launch
          initFirestore();
          // Launch Article Information
          displayArticleFire(getUrlVars()["article"]);
